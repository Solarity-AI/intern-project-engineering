...
| **Frontend** | Kotlin, Jetpack Compose, Hilt, Retrofit | `frontend/` |
...
└── frontend/                # Android Kotlin Frontend
...
3. Navigate to `ProductReviewApp-Kotlin-FW/frontend`
4. Click "OK"
...
Edit `frontend/app/build.gradle.kts`:
```kotlin
defaultConfig {
...
1. Open Android Studio
2. Open project: `ProductReviewApp-Kotlin-FW/frontend`
...
cd ProductReviewApp-Kotlin-FW/frontend
